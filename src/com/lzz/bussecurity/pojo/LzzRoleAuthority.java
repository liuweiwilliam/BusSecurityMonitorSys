...
public class LzzRoleAuthority {
	...
	public LzzRoleAuthority(){
		this.id = LzzIDMgr.self().getID();
	}
	
	public LzzRoleAuthority(boolean need_id){
		if(need_id){
			this.id = LzzIDMgr.self().getID();
		}
	}
	
	public LzzRoleAuthority(LzzRoleAuthority obj){
	    id = obj.getId();

	    roleId = obj.getRoleId();

	    authorityId = obj.getAuthorityId();
	...
	public LzzRoleAuthority clone(){
		LzzRoleAuthority rslt = new LzzRoleAuthority(false);
		rslt.id = this.getId();

		rslt.roleId = this.getRoleId();

		rslt.authorityId = this.getAuthorityId();
	...
	public void constructWith(LzzRoleAuthority pro) {
		// TODO Auto-generated method stub
		this.id  = pro.getId ();

		this.roleId  = pro.getRoleId ();

		this.authorityId  = pro.getAuthorityId ();
