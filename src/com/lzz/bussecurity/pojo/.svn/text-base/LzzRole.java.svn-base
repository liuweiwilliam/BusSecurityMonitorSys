...
public class LzzRole {
	...
	public LzzRole(boolean need_id){
		if(need_id){
			this.id = LzzIDMgr.self().getID();
		}
	}
	
	public LzzRole(LzzRole obj){
	    id = obj.getId();

	    name = obj.getName();

	    isDefaultRole = obj.getIsDefaultRole();
	...
	public LzzRole clone(){
		LzzRole rslt = new LzzRole(false);
		rslt.id = this.getId();

		rslt.name = this.getName();

		rslt.isDefaultRole = this.getIsDefaultRole();
	...
	public void constructWith(LzzRole pro) {
		// TODO Auto-generated method stub
		this.id  = pro.getId ();

		this.name  = pro.getName ();

		this.isDefaultRole  = pro.getIsDefaultRole ();
