...
public class LzzSensorData {
	...
	public LzzSensorData(){};
	
	public LzzSensorData(LzzSensorData obj){
	    id = obj.getId();
	...
	public void constructWith(LzzSensorData pro) {
