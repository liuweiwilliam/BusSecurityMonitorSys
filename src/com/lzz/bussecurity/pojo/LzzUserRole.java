...
public class LzzUserRole {
	...
	public LzzUserRole(boolean need_id){
		if(need_id){
			this.id = LzzIDMgr.self().getID();
		}
	}
	
	public LzzUserRole(LzzUserRole obj){
	    id = obj.getId();
	...
	public LzzUserRole clone(){
		LzzUserRole rslt = new LzzUserRole(false);
		rslt.id = this.getId();
	...
	public void constructWith(LzzUserRole pro) {
