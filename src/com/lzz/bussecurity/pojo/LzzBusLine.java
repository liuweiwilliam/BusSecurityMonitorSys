...
public class LzzBusLine {
	...
	public LzzBusLine(LzzBusLine obj){
	    id = obj.getId();

	    lineNum = obj.getLineNum();
	...
	public LzzBusLine clone(){
		LzzBusLine rslt = new LzzBusLine();
		rslt.id = this.getId();

		rslt.lineNum = this.getLineNum();

		rslt.companyId = this.getCompanyId();
	...
	public void constructWith(LzzBusLine pro) {
		// TODO Auto-generated method stub
		this.id  = pro.getId ();

		this.lineNum  = pro.getLineNum ();

		this.companyId  = pro.getCompanyId ();
